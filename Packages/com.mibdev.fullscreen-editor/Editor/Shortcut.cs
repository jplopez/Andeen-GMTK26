...
namespace FullscreenEditor {
    ...
    internal class Shortcut {
        ...
        [DynamicMenuItem(false)] public const string CURRENT_VIEW_PATH = "Fullscreen/Focused View ";
        [DynamicMenuItem(false)] public const string GAME_VIEW_PATH = "Fullscreen/Game View _F9";
